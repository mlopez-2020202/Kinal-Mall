...
import org.mynorlopez.bean.Login;
...
public class LoginController implements Initializable{
    ...
    private void Login()throws NoSuchAlgorithmException{
        ...
        lo.setPasswordLogin(psfPassword.getText());
        ...
        while (x < getUsuario().size()){
            ...
            if (user.equals(lo.getUsuarioMaster()) && pass.equals(lo.getPasswordLogin())){
                JOptionPane.showMessageDialog(null, "Sesión Iniciada " + getUsuario().get(x).getNombreUsuario()
